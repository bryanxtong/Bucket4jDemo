 ...
 *
 */
public class HazelcastSyncCacheResolver extends AbstractCacheResolverTemplate<String> implements SyncCacheResolver {

    private final HazelcastInstance hazelcastInstance;

    private final boolean async;

    public HazelcastSyncCacheResolver(HazelcastInstance hazelcastInstance, boolean async) {
